  ...
  return (
    <div className="min-h-screen bg-background relative noise-overlay">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-48 left-1/2 -translate-x-1/2 w-[600px] h-[600px] rounded-full bg-gold/[0.04] blur-[150px]" />
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full bg-rose-accent/[0.02] blur-[120px]" />
        <div className="absolute top-1/3 right-0 w-[300px] h-[300px] rounded-full bg-gold/[0.02] blur-[100px]" />
      </div>
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 py-12">
        ...
        >
          ...
          <div className="p-10 sm:p-12 rounded-3xl bg-surface border border-border glow-gold-strong text-center animate-border-glow">
            ...
            <h1 className="text-5xl sm:text-6xl font-display font-bold text-gold text-glow mb-2 animate-shimmer bg-gradient-to-r from-gold-light via-gold to-gold-dark bg-clip-text text-transparent">
            ...
            {settings.party_message && (
              <div className="mb-8 p-5 rounded-2xl bg-rose-accent/[0.04] border border-rose-accent/10">
